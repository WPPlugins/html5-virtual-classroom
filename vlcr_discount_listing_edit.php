...
$class_data = $vc_obj->vlcr_class_detail($_REQUEST['cid']);
...
$cid = $_REQUEST['cid'];
$discountVal = $vc_obj->vlcr_discount_detail($discountid,$cid);
?>
...
<form class="form-horizontal form-validate" id="adminForm" action="" method="post"  enctype="multipart/form-data">
       <div class="add-on after" style="margin-left: 190px; margin-bottom: 5px;"> 
        ...
        <div class="control-group">
         ...
         <div class="control-group" style="float: left; width: 384px;">
        ...
        <div class="control-group" style="float: left; width: 384px;">
            ...
            <div class="controls" style="margin-left: 35px;">
              ...
              <input type="text" placeholder="discount" id="discount" name="discount" value="<?php echo @$discountVal->special_price;?>" style="width: 55px; margin-top: -2px;">
