		   ...
		   { 
            ?>
             ...
             <?php if($list_user->is_teacher == 1) {?>
                        ...
                        <a href="<?php echo wp_nonce_url(admin_url('admin.php?page='.VC_FOLDER.'/vlcr_setup.php/TeacherList&task=unpublishuser&user_id='.$list_user->ID.''))?>" class=""><img src="<?php echo VC_URL?>/images/tick.png" alt="Tooltip"></a>
                        </span>
                        <?php } else{ ?>
                        <span class="hasTip" title="Make User">
                        <a href="<?php echo wp_nonce_url(admin_url('admin.php?page='.VC_FOLDER.'/vlcr_setup.php/TeacherList&task=publishuser&user_id='.$list_user->ID.''))?>" class=""><img src="<?php echo VC_URL?>/images/publish_x.png" alt="Tooltip"></a>
                        </span>
