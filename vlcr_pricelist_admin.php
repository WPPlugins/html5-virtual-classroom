...
<thead>
    <tr>
    	<td colspan="12">
        	<a class="button button-primary button-large" href="<?php echo wp_nonce_url(admin_url('admin.php?page='.VC_FOLDER.'/vlcr_setup.php/PriceList&action=add&cid='.$_REQUEST['cid'].''))?>">Add</a>
